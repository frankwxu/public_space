...
\newcommand{\coursecode}{CYFI 445}
\newcommand{\coursename}{Forensic Data Analysis}
...
\newcommand{\lecturetime}{Mo 13:00--16:45}
\newcommand{\zoomlink}{https://ubalt.zoom.us/s/5547149563}
\newcommand{\officephone}{410-837-5302}
\newcommand{\officelocation}{LAP 526}

\newcommand{\coursedescription}{This course introduces concepts and techniques in data analytics and analysis for discovering forensic evidence. Students apply basic statistical, machine-learning, and artificial-intelligence tools to describe, visualize, and analyze forensic data collected from computing devices. The course focuses on detecting anomalies in collected forensic log files.\par\textbf{Prerequisites:} CYFI 305, CYFI 315, CYFI 345, CYFI 360, and CYFI 415.}
...
\begin{itemize}
  \item \textbf{Hybrid (HYB):} In-person attendance on campus is required on September 14, September 28, October 12, October 26, and November 9; all remaining lectures will be held remotely via Zoom.
  \item \textbf{Zoom (ZM):} Remote attendance via Zoom is required for all class sessions.
\end{itemize}

\section{Student Learning Outcomes}
\begin{itemize}
  \item Describe data analytics and its role in forensic investigations.
  \item Apply basic statistical concepts to interpret the characteristics of forensic data.
  \item Apply basic tools to carry out data-visualization tasks.
  \item Describe basic data-mining algorithms and select appropriate algorithms for predictive modeling.
  \item Apply basic data-mining, machine-learning, and deep-learning algorithms and tools to detect anomalies in forensic log files.
  \item Evaluate forensic analysis results.
\end{itemize}

\section{Textbook and Learning Resources}
\begin{itemize}
  \item \textbf{No required textbook:} \href{https://www.learnpytorch.io/}{\nolinkurl{https://www.learnpytorch.io/}}
  \item \href{https://github.com/frankwxu/agentic-AI4-forensics}{\nolinkurl{https://github.com/frankwxu/agentic-AI4-forensics}}
  \item \href{https://github.com/frankwxu/AI4DigitalForensics/tree/main/lectures}{\nolinkurl{https://github.com/frankwxu/AI4DigitalForensics/tree/main/lectures}}
  \item \href{https://github.com/dair-ai/ML-YouTube-Courses}{\nolinkurl{https://github.com/dair-ai/ML-YouTube-Courses}}
\end{itemize}
...
\begin{itemize}
  \item Python Basics
  \item LLM Foundations
  \item Environment Setup
  \item LLM API and Model Basics
  \item AI Agents
  \item Reflection Pattern
  \item Tool-Use Pattern
  \item ReAct Pattern
  \item Planning Pattern
  \item Multi-Agent Pattern
\end{itemize}
