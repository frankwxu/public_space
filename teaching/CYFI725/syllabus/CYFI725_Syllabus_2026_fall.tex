...
\begin{itemize}
  ...
  \item \textbf{Book:} \href{https://github.com/frankwxu/digital-forensics-lab/blob/main/papers/books/Digital_Forensics_Introduction.pdf}{Digital Forensics Introduction PDF}. \textbf{Access:} Available to enrolled students.
\end{itemize}
