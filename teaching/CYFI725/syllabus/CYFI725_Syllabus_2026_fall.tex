...
\begin{itemize}
  ...
  \item \textbf{Book:} \href{https://github.com/frankwxu/public_space/blob/main/teaching/CYFI725/cyfi725_book.pdf}{Digital Forensics Introduction PDF}. \textbf{Access:} Available to enrolled students.
\end{itemize}
