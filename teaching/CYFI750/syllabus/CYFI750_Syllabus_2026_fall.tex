% Content-first syllabus template. Update the course details below for a new offering.
...
\newcommand{\coursecode}{CYFI 750/490}
\newcommand{\coursename}{Forensic Incident Response/Capstone}
...
\newcommand{\lecturetime}{Th 17:30--21:15}
\newcommand{\zoomlink}{https://ubalt.zoom.us/s/5547149563}
\newcommand{\officephone}{410-837-5302}
\newcommand{\officelocation}{LAP 526}

% Optional content fields. Leave a field empty to omit its section from the PDF.
% Example: \renewcommand{\coursedescription}{This course introduces \ldots}
\newcommand{\coursedescription}{This course integrates and applies the knowledge, theories, principles, skills, and practical applications learned in the Master of Science in Forensic Science---Cyber Investigations program to actual cybercrime case scenarios.\par\textbf{Prerequisite:} Successful completion of all core courses in the program and permission from the program director.}
...
\begin{minipage}[t]{0.4\textwidth}
  ...
  \textbf{Lecture time:} \lecturetime\\
...
This syllabus and related course instructions are available at \url{https://github.com/frankwxu/public_space}.
...
The course meets every Thursday and is offered in two formats:

\begin{itemize}
  \item \textbf{Hybrid (HYB):} In-person attendance on campus is required on September 17, October 1, October 15, October 29, and November 12; all remaining lectures will be held remotely via Zoom.
  \item \textbf{Zoom (ZM):} Remote attendance via Zoom is required for all class sessions.
\end{itemize}

\section{Student Learning Outcomes}
\begin{itemize}
  \item Survey cybercrime scenarios, key cybercrime activities, and digital evidence associated with the activities.
  \item Mimic cybercrime activities in a controlled environment.
  \item Design forensic approaches and practice techniques to acquire snapshots of computing systems.
  \item Apply an evidence-based approach to systematically re-create cybercrime scenarios.
  \item Develop comprehensive cyber investigation reports.
\end{itemize}

\section{Textbook}
\begin{itemize}
  \item \textbf{Optional:} Xu, Weifeng, Lin Deng, and Mohit Dhabuwala. 2025. \emph{Digital Forensics Basics: A Step-by-Step Guide for Beginners: An Open-Source Approach} (Second Edition). Kindle edition. August 1. Amazon. \href{https://www.amazon.com/dp/B0HH8WQSMK}{\nolinkurl{https://www.amazon.com/dp/B0HH8WQSMK}}.
  \item \textbf{Optional textbook:} \emph{Incident Response \& Computer Forensics}, McGraw-Hill Education, 3rd edition, Jason T. Luttgens, Matthew Pepe, and Kevin Mandia, ISBN 978-0071798686, 2014.
  \item \textbf{Supplemental PDF:} \href{https://github.com/frankwxu/digital-forensics-lab/blob/main/papers/books/Digital_Forensics_Andriod.pdf}{Digital Forensics PDF}. \textbf{Access:} Available to enrolled students.
\end{itemize}

\Needspace{10\baselineskip}
\section{Course Topics (Tentative)}
\begin{itemize}[leftmargin=1.8em,label={},itemsep=0pt,topsep=0pt,parsep=0pt,partopsep=0pt]
  \item \textbf{Introduction}
  \item[1.] Course Overview
  \item[2.] Basic Computer Skills (Linux)
  \item \textbf{Mobile Investigation}
  \item[3.] Android Device and Images
  \item[4.] Device and System Investigation
  \item[5.] Application Life Cycle
  \item[6.] AOSP App Investigation
  \item \textbf{Midterm}
  \item[7.] GMS App Investigation -- Messaging
  \item[8.] GMS App Investigation -- Dialer
  \item[9.] GMS App Investigation -- Map/Photo
  \item[10.] GMS App Investigation -- Kik/TextNow
  \item[11.] GMS App Investigation -- WhatsApp
  \item[12.] Other Topics (iOS) -- Optional
  \item[13.] Other Topics (IoT) -- Optional
  \item[14.] Final Exam Presentation
\end{itemize}
...
\textbf{Potential Grade Adjustments for Active Engagement:} Final grades near the next higher letter-grade threshold (e.g., 89\% or 89.5\% near the 90\% threshold for an A-) may be considered for a \textbf{discretionary upgrade}. Adjustments are not guaranteed and depend on the instructor's assessment of your overall active engagement during Zoom sessions. Examples include keeping your camera on during group discussions, regularly contributing via audio, or consistently participating.

\begin{policybox}
  \textbf{Grade policy}
  \begin{itemize}
    \item \textbf{Submission requirements:} All labs, assignments, and quizzes must be submitted through Canvas unless otherwise instructed by the instructor.
    \item \textbf{Late submissions:} Late homework, quizzes, and labs will not be accepted for credit.
    \item \textbf{Attendance:} Missing two or more class sessions will result in a failing course grade.
    \item \textbf{Make-up assessments:} Make-up quizzes and exams require prior arrangements with the instructor.
    \item \textbf{Technical questions:} When emailing a technical question, include relevant screenshots, the commands you used, and the steps you took to verify your results.
    \item \textbf{Grade appeals:} Submit grade appeals by email within two weeks of receiving the grade. Appeals submitted after this deadline will not be considered.
    \item \textbf{Grade calculation:} Final course percentages are calculated by dividing points earned by total available points and multiplying by 100.
  \end{itemize}
\end{policybox}
...
Lectures may be recorded. When available, recordings can be accessed through Panopto in the course's Canvas site.
